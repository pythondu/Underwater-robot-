...
GPIO.setup(servopin21, GPIO.OUT, initial=False)
...
p21 = GPIO.PWM(servopin21,50) #50HZ
...
while(True):
	...
	#GPIO.output(pin2,False)             #left-machin
	#GPIO.output(pin3,True)				#turn-right

	GPIO.output(pin1,False)                #light     
	GPIO.output(pin4,True)

	#GPIO.output(pin5,False)               #right-machin
	#GPIO.output(pin6,True)					#turn-left
